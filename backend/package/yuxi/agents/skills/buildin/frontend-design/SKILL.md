...
description: "创建高质量、有设计感的前端界面，避免千篇一律的 AI 风格。当用户要求构建网页组件、页面、海报、仪表盘、React/Vue 组件、HTML/CSS 布局，或美化任何 Web UI 时使用。"
---
...
- **Backgrounds & Visual Details**: Create atmosphere and depth rather than defaulting to solid colors. Apply creative forms like gradient meshes, noise textures, geometric patterns, layered transparencies, dramatic shadows, decorative borders.
...
- Save generated files to the current Workdir `outputs/` directory
- Present files to the user using `present_artifacts`

## License

This skill is adapted from DeerFlow's frontend-design skill, originally licensed under Apache License 2.0. See LICENSE.txt in the skill directory for full license terms.
