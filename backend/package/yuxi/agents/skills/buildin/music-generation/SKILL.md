...
description: "当用户要求生成、创建、作曲或制作音乐/歌曲时使用——背景音乐、主题曲、铃声或器乐。通过 MiniMax 音乐 API 从风格/情绪提示和可选歌词生成歌曲。"
---
...
```bash
python /home/gem/skills/music-generation/scripts/generate.py \
...
- Music is saved as MP3 (in `outputs/`).
- Share the generated file with the user using the `present_artifacts` tool.
